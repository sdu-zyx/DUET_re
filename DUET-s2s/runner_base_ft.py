...
# using hyper ft dataloader without dynamic ids
from trainer import BaseFT_Train
...
def main():
    ...
    parser.add_argument("--model_name", default='DUET-base-40prefreeze', type=str)
    ...
    trainer = BaseFT_Train(model, args)
    ...
    if args.do_eval:
        ...
        pretrained_path = os.path.join(args.output_dir, f'DUET-pre-{args.data_name}.pt')
        try:
