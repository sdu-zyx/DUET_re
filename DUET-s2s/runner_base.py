...
from dataset import DUETBaseData
...
def main():
    ...
    parser.add_argument("--model_name", default='DUET-base', type=str)
    ...
    train_dataset = DUETBaseData(args, train_data, data_type='train')
    ...
    eval_dataset = DUETBaseData(args, valid_data, test_neg_items=sample_seq, data_type='valid')
    eval_sampler = SequentialSampler(eval_dataset)
    eval_dataloader = DataLoader(eval_dataset, sampler=eval_sampler, batch_size=args.batch_size)

    test_dataset = DUETBaseData(args, test_data, test_neg_items=sample_seq, data_type='test')
    test_sampler = SequentialSampler(test_dataset)
    test_dataloader = DataLoader(test_dataset, sampler=test_sampler, batch_size=args.batch_size)

    trainer = Base_Train(model, args)
